...
const reduceRightAsync_1 = require("./reduceRightAsync");
describe('reduceRightAsync', () => {
    const input = [1, 2, 3, 4, 5];
    it('should guarantee order and receive all iteratee params', async () => {
        const fn = jest.fn((acc, i, index) => Promise.resolve(acc + i * index));
        const result = await reduceRightAsync_1.reduceRightAsync(input, fn);
...
//# sourceMappingURL=reduceRightAsync.test.js.map